...
from .seed_uni import seed_campuses, seed_fundings, seed_budgets
...
async def seed_all(db: LocalSession):
    ...
    await log_seed_fn("funding", seed_fundings)(db)
    await log_seed_fn("research_budget", seed_budgets)(db)
