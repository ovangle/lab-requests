...
import { ResourceContainerForm, ResourceContainerFormControls, ResourceContainerFormErrors, resourceContainerFormControls, resourceContainerPatchFromForm } from "../resource/resource-container-form.service";
...
export function workUnitFormErrors<TKey extends ErrKey>(form: WorkUnitForm, field: TKey): WorkUnitFormErrors[TKey] | null {
