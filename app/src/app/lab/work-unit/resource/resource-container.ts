...
} from '../resources/equipment/equipment-lease';
import {
  InputMaterial,
  InputMaterialParams,
  inputMaterialFromJson,
  inputMaterialToJson,
} from '../resources/input-material/input-material';
import {
  OutputMaterial,
  OutputMaterialParams,
  outputMaterialFromJson,
  outputMaterialParamsToJson,
} from '../resources/output-material/output-material';
import {
  Software,
  SoftwareParams,
  softwareFromJson,
  softwareParamsToJson,
} from '../resources/software/software';
import {
  Task,
  TaskParams,
  taskFromJson,
