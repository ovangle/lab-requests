...
import { BehaviorSubject, Subscription, filter, first, firstValueFrom, switchMap, tap } from "rxjs";

import { Resource, ResourceContext, ResourceTypeIndex, isResourceTypeIndex } from "./resource";
...
export class ResourceFormService<T extends Resource, TForm extends FormGroup<any>> {
    ...
    readonly _typeIndexSubject = new BehaviorSubject<ResourceTypeIndex | undefined>(undefined);
