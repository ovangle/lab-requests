...
} from '../../resource/common/resource-table.component';
...
@Component({
  ...
  template: `
    ...
    >
      <lab-resource-table-info-header> </lab-resource-table-info-header>
    ...
    <ng-template #detailTemplate let-element let-index="index">
      <lab-task-resource-details [task]="element"> </lab-task-resource-details>
    </ng-template>
  `,
  providers: [
    {
