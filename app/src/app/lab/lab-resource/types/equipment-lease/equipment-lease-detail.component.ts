...
import { EquipmentProvisionInfoComponent } from 'src/app/equipment/provision/equipment-provision-info.component';
...
@Component({
  ...
  template: `
    @if (equipment | async; as equipment) {
      ...
      <equipment-provision-info [provision]="equipmentProvision" />
    }
  `,
})
