...
import { WorkUnit, WorkUnitLookup, WorkUnitMeta, WorkUnitPatch } from "../../work-unit/common/work-unit";
...
import { ExperimentalPlan, ExperimentalPlanContext } from "../common/experimental-plan";


@Injectable()
export class ExperimentalPlanWorkUnitService
extends ModelService<WorkUnit, WorkUnitPatch, WorkUnitLookup> {
    ...
    override queryPage(lookup: Partial<WorkUnitLookup>): Observable<ModelResponsePage<WorkUnit, WorkUnitLookup>> {
        const params = this.lookupToHttpParams(lookup);
        return this.resourcePath$.pipe(take(1), 
