...
} from '../work-unit/resource/file-attachment/file-attachment';
...
export class SoftwareMeta extends ModelMeta<
  Software,
  SoftwarePatch,
  SoftwareLookup
> {
...
@Injectable({ providedIn: 'root' })
export class SoftwareModelService extends RestfulService<
  Software,
  SoftwarePatch,
  SoftwareLookup
> {
