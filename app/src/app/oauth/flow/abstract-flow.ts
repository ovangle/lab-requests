...
import { AccessTokenData, AccessTokenResponse, accessTokenResponseToAccessTokenData } from "../access-token";
...
import { OauthFlowState, OauthFlowStateParams, OauthFlowStateStore } from "./flow-state-store.service";
...
@Injectable()
export abstract class OauthFlowFactory<GrantType extends OauthGrantType> implements OauthFlowEnv {
...
export abstract class AbstractOauthFlow<
    ...
    GrantRequest extends OauthGrantRequest<GrantType> = OauthGrantRequest<GrantType>, 
...
> {
    ...
    abstract generateInitialState(params: OauthFlowStateParams<FlowState>): Promise<FlowState>;
