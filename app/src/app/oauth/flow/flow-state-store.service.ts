...
export type OauthFlowStateParams<T extends OauthFlowState<any>> = Omit<T, 'grantType' | 'provider'>;

export function oauthFlowState<GrantType extends OauthGrantType, State extends OauthFlowState<GrantType>>(
...
export class OauthFlowStateStore {
    ...
    initialize<GrantType extends OauthGrantType, State extends OauthFlowState<GrantType>>(state: State): void {
    ...
    load<GrantType extends OauthGrantType, State extends OauthFlowState<GrantType>>(): State {
        this.checkIsAnyFlowInProgress();
        return this._load();
    }

    update<GrantType extends OauthGrantType, State extends OauthFlowState<GrantType>>(state: State) {
