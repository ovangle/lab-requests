...
import { BehaviorSubject, NEVER, Observable, combineLatest, defer, filter, map, of, shareReplay, skip, skipUntil, switchMap, tap, withLatestFrom } from "rxjs";
...
export class CurrencyInputComponent implements ControlValueAccessor {
    ...
    constructor() {
        ...
        this.formattedValue$.subscribe(
            value => this._control.setValue(value, {
                emitEvent: false
            })
        );
    }
